...
function Shop4() {
  ...
  const {shirt , shirtItems , selectedBrands , handleChange , sortingData , handleChangeAvailable ,notAvailableItems, availableItems , selectedAvailable} = useContext(shirtContext)
  
  const products = shirtItems.map((el , index)=> {
    return (
  ...
  const uniqueAvailable = [...new Set(shirt.map(item => item.available))];

  const availableShirt = uniqueAvailable.map((el, index) => {
  ...
  const uniqueBrands = [...new Set(shirt.map(item => item.brand))];
    ...
    <div className="Shop SecThree">
      <div className="title">
        <div className="container  py-5">
          ...
          <p className="h2 mt-4">T-Shirts</p>
        </div>
      </div>
      <div className="body">
        ...
        <div className="py-1">
            ...
            <div className="col-lg-9 col-md-8 col-sm-12">
              ...
              <div className="d-flex justify-content-between align-items-center px-3 py-2" style={{ fontSize: "12px",borderBottom : "1px solid white"}}>
                <p className="m-0">Home / <span>T-Shirts</span></p>
