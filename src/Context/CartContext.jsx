...
export const AddToCartProvider = ({children})=> {
    ...
    const totalPrice = cart.reduce((a, b)=> {
        ...
        if(!b.discount) {
            ...
            return a + (b.amount * ((+b.price - (+b.price * (+b.discount / 100) )).toFixed(0)))
        }
    ...
    return (
        <cartContext.Provider value={{addToCart , cart , deleteProduct , changeQuantity , totalPrice , totalItems}}>
            {children}
